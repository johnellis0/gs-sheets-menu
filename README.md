...
* [SheetMenu](#SheetMenu)
    ...
    * [.draw()](#SheetMenu+draw)
    * [.get(settingName, reloadCache)](#SheetMenu+get) ⇒ <code>\*</code>
...
### sheetMenu.get(settingName, reloadCache) ⇒ <code>\*</code>
...
| reloadCache | <code>boolean</code> | Whether to reload the cache from the values on the sheet |
